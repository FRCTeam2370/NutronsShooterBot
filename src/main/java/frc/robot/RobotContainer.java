...
import frc.robot.commands.Drive.AimAndShootLime;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystick.rightTrigger().whileTrue(new Shoot(50, mShooter, mIntakeSubsystem, mLEDSubsystem));//80 is really good =)
    ...
    joystick.start().toggleOnTrue(new AimAndShootLime(drivetrain, mLimelight, mShooter, mIntakeSubsystem, mLEDSubsystem));
    joystick.x().toggleOnTrue(new AimAndShootAutoLime(drivetrain, mLimelight, mShooter, mIntakeSubsystem, mLEDSubsystem));

    joystick.b().onTrue(new Stow(mShooter));

    joystick.leftStick().whileTrue(new AimShooter(mShooter, 4.45));

    joystick.y().toggleOnTrue(new SliderAimShooter(mShooter));
  ...
  public RobotContainer() {
    NamedCommands.registerCommand("Shoot", new Shoot(85, mShooter, mIntakeSubsystem, mLEDSubsystem));
    ...
    NamedCommands.registerCommand("AutoShoot", new AimAndShootAutoLime(drivetrain, mLimelight, mShooter, mIntakeSubsystem, mLEDSubsystem));
