...
public class AimWithLimelightTele extends Command {
  private CommandSwerveDrivetrain drivetrain;
  private Limelight mLimelight;
  PIDController LimelightTurnPID = new PIDController(1,0, 0);
  /** Creates a new AimWithLimelight. */
  public AimWithLimelightTele(CommandSwerveDrivetrain drivetrain, Limelight mLimelight) {
  ...
  public void initialize() {
    CommandSwerveDrivetrain.drive.withVelocityX(0).withVelocityY(0).withRotationalRate(0);
  }
